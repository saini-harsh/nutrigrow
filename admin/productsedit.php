                    ...
                    <div class="cbox">
                        <form action="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="modal-body">
                                <?php
                                $id = $_GET['id'];
                                $sql = "SELECT `file_path`, `type`, `price`, `description`, `time` FROM `products` WHERE id = '$id'";
                        ...
                        if (isset($_POST['edit-btn'])) {
                            ...
                            $update_data = "UPDATE products SET products.file_path='$file_path',products.type='$type', products.price='$price',products.description='$description',products.time='$time' WHERE products.id='$id' ";
                        ...
                        if (isset($_POST['edit-btn'])) {
                            ...
                            if ($check) {
                                ...
                                $update_data = "UPDATE products SET products.file_path='$file_name',products.type='$type', products.price='$price',products.description='$description',products.time='$time' WHERE products.id='$id' ";
