                    ...
                    <div class="cbox">
                        <div class="table-responsive">
                            <table id="myTable" class="display table table-bordered" style="width: 100%;">
                                <div class="py-3">
                                    <a href="blogsadd.php"><button class="mx-auto d-block btn-primary ">Add Now</button></a>
                                </div>
                                <thead>
                                    <tr>
                                        <th>#</th>
                                            ...
                                            <tr>
                                                ...
                                                <td><img style="width: 100px;" class="img-fluid" src="<?php
                                                                                                        if (isset($row['user_img']))
                                                                                                            echo "uploads/blogs/" . $row['user_img'];
                                                                                                        ?>" alt=""></td>
                                                ...
                                                <td>
                                                    <a class="btn1 btn btn-primary" href="blogsedit.php?id=<?php echo $row['id'] ?>">Edit</a>
                                                    <a class="btn btn-danger" href="blogsdelete.php?id=<?php echo $row['id']; ?>">Delete</a>
                                                </td>
