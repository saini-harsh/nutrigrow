                        ...
                        <div class="table-responsive">
                            <table id="myTable" class="display table table-bordered ">
                                ...
                                <tbody>
                                    ...
                                    $sql = "SELECT * from get_touch_data ";
                                    ...
                                    ?>
                                            ...
                                            <tr style="text-transform: uppercase;">
                                                ...
                                                <td>
                                                    <a class="btn1 btn btn-primary" href="getintouchedit.php?id=<?php echo $row['id'] ?>">Edit</a>
                                                    <a class="btn btn-danger" href="getintouchdelete.php?id=<?php echo $row['email']; ?>">Delete</a>
                                                </td>
                                            </tr>
                                    <?php
