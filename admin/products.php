                    ...
                    <div class="cbox">
                        <div class="table-responsive">
                            <table id="myTable" class="display table table-bordered" style="width: 100%;">
                                <div class="py-3">
                                    <a href="productsadd.php"><button class="mx-auto d-block btn-primary ">Add Now</button></a>
                                </div>
                                <thead>
                                    <tr>
                                        <th>#</th>
                                            ...
                                            <tr>
                                                ...
                                                <td><img style="width: 100px;" class="img-fluid" src="<?php
                                                                                                        if (isset($row['file_path']))
                                                                                                            echo "uploads/products/" . $row['file_path'];
                                                                                                        ?>" alt=""></td>
                                                ...
                                                <td>
                                                    <a class="btn1 btn btn-primary" href="productsedit.php?id=<?php echo $row['id'] ?>">Edit</a>
                                                    <a class="btn btn-danger" href="productdelete.php?id=<?php echo $row['id']; ?>">Delete</a>
                                                </td>
