                ...
                <div class="row">
                    <div class="col">
                        <div class="cbox">
                            ...
                            if ($_SERVER['REQUEST_METHOD'] === 'POST') {
                                ...
                                if ($err_count === 0) {
                                    ...
                                    if ($pass === $cfpass) {
                                        ...
                                        $sql_insert = "INSERT INTO `admin_signup_data`(`fname`, `lname`, `email`, `phone`, `pass`) VALUES ('$fname','$lname','$email','$phone','$pass')";

                                        if (mysqli_query($conn, $sql_insert)) {
                                            $_SESSION['adminsigninemail'] = $email;
                            ?>
                                            <script>
                            ...
                            <form action="" method="POST" onsubmit="return adminsvalidate(this);">
                                <div class="row d-flex align-items-center mt-3">
                                    <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                        <input type="text" name="fname" id="fname" placeholder="First Name" onblur="adminforname(this)">
                                    ...
                                    <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                        <input type="text" name="lname" id="lname" placeholder="Last Name" onblur="adminforname(this)">
                                    ...
                                    <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                        <input type="email" name="email" id="email" placeholder="Email Address" onblur="adminforname(this)">
                                    ...
                                    <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                        <input type="tel" name="phone" id="phone" maxlength="10" placeholder="Phone Number" onblur="adminforname(this)">
                                    ...
                                    <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                        <input type="password" name="pass" id="pass" placeholder="Password" onblur="adminforname(this)">
                                    ...
                                    <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                        <input type="password" name="cfpass" id="cfpass" placeholder="Confirm Password" onblur="adminforname(this)">
                                        <span class="err">
                                            <h6 id="scfpass"></h6>
                                        </span>
                                    </div>
